...
def main() -> None:
    ...
    raw_output_response = ollama.chat(
        model=CHAT_MODEL,
        messages=[{"role": "user", "content": user_prompt}],
    )
    raw_output = raw_output_response["message"]["content"]

    optimized_output_response = ollama.chat(
        model=CHAT_MODEL,
        messages=[{"role": "user", "content": optimized_prompt}],
    )
    optimized_output = optimized_output_response["message"]["content"]
